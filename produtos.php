            ...
            <div class="col">
                <div class="card h-100 shadow border-0 bg-dark text-white">
                    ...
                    <div class="p-3 bg-white d-flex align-items-center justify-content-center container-foto-produto">
                        <img src="img/<?php echo $produto['imagem']; ?>" class="img-fluid foto-produto" alt="<?php echo $produto['nome']; ?>">
                    </div>
                    ...
                    <div class="card-body d-flex flex-column text-center">
                        ...
                        <a href="produto-detalhes.php?id=<?php echo $produto['id']; ?>" class="btn btn-outline-light btn-sm w-100">Ver produto</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
